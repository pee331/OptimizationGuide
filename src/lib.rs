// src/lib.rs
/*
 * Core library for OptimizationGuide
 */
...
#[derive(Debug)]
pub struct OptimizationGuideProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OptimizationGuideProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OptimizationGuide processing");
    
    let mut processor = OptimizationGuideProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OptimizationGuideProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OptimizationGuideProcessor::new(false);
